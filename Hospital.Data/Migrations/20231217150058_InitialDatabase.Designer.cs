...
namespace Hospital.Data.Migrations
{
    ...
    [Migration("20231217150058_InitialDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hospital.Data.Branch", b =>
                {
            ...
            modelBuilder.Entity("Hospital.Data.Policlinic", b =>
                {
                    b.Property<int>("policlinicId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Hospital.Data.User", b =>
                {
                    b.Property<int>("userId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Hospital.Data.Appointment", b =>
                {
                    ...
                    b.HasOne("Hospital.Data.User", "user")
                        .WithMany("appointments")
            ...
            modelBuilder.Entity("Hospital.Data.Doctor", b =>
                {
                    b.HasOne("Hospital.Data.Branch", "branch")
                        .WithMany("doctors")
                        .HasForeignKey("branchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hospital.Data.Policlinic", "policlinic")
                        .WithMany("doctors")
